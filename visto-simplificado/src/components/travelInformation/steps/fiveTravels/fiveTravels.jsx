        ...
        <div className="div-margin">
            ...
            <div className="div-marital-padding">
                <div style={{ paddingBottom: '1rem', paddingLeft:'1rem' }}>
                    <span className="span-state">Caso você tenha menos que 5 viagens, preencha apenas as viagens que você fez, deixe as outras em branco!</span>
                </div>
                <div style={{ paddingBottom: '1rem', paddingLeft:'1rem' }}>
                    <span className="span-state">Obs. 1: A data de chegada pode ser uma data estimada da sua viagenm,caso não lmebre a data exata em que foi.</span>
                </div>
                <div style={{ paddingBottom: '1rem', paddingLeft:'1rem' }}>
                    <span className="span-state">Obs. 2: O tempo de estadia deve ser em dias</span>
                </div>
            </div>
        </div>
    )
